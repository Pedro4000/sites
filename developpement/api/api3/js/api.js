...
function requestShowTimesInFrance(id,location,date) {

    console.log(id);
    console.log(location);
    console.log(date);
    $.ajax({
    url: "https://api.internationalshowtimes.com/v4/showtimes/?movie_id=46793&location="+location+"&distance=5&time_to="+date,
    type: "GET",
    datatype: "json",
    data: {
        "countries": "FR",
